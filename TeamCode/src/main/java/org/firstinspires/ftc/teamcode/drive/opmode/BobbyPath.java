...
public class BobbyPath extends LinearOpMode {
    @Override
    public void runOpMode() {
        SampleMecanumDrive drive = new Sampl eMecanumDrive(hardwareMap);

        drive.setPoseEstimate(new Pose2d(50, 50, Math.toRadians(270)));
        Trajectory cool = drive.trajectoryBuilder(new Pose2d(50, 50, 270))
                        .lineTo(new Vector2d(50, -50)).build()
